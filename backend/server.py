...
# Platform service fee applied to released milestones — both the expert's
# invoice and their payout derive from this same rate so the books always
# reconcile. Configurable so the rate can be tuned without a code change.
